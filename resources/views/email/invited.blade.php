...
<table width="90%" align="center" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td colspan="2">
        ...
        ">
            ...
            ¡Hola! <b>{{ $mailData['invited_name'] }}</b>
            <br />
        </p>
        <p style="
          font-size: 14px;
        ...
        ">
            <!-- "288 Pellentesque VW." replace to your address 1 -->
            Te acaba de llegar una invitación por parte de <b>{{ $mailData['sponsor_name'] }}</b>
            <br />
        </p>
  ...
  <tr>
    <td colspan="2" align="center">
        <p>Si en caso quieres el link de la invitación:</p>
        <p style="color: #cecece;">{{ $mailData['url'] }}</p>
